...
public class AzureADAuthTemplate implements AzureADAuthOperations {
	...
	public AzureADAuthTemplate(String clientId, String clientSecret, String domain, String authority, String resourceUrl, String partnerServiceApiRoot){
		this(
				...
				UriProvider.builder()
						.authority(authority)
						.azureServiceApiRoot(partnerServiceApiRoot)
	...
	public AzureADAuthTemplate(String clientId, String clientSecret, String domain, UriProvider uriProvider) {
		...
		this.authorizeUrl = uriProvider.buildAzureOAuth2Uri(domain);
	...
	public AccessGrant exchangeForAccess(){
		...
		return new AccessGrant(azureADSecurityToken.getAccessToken(), null, null, Long.parseLong(azureADSecurityToken.getExpiresIn()));
	}
	...
	protected RestTemplate createRestTemplate() {
		...
		restTemplate.getInterceptors().add(new ApiVersionParameterRequestInterceptor("1.6"));
	...
	public AccessGrant exchangeCredentialsForAccess(String username, String password, MultiValueMap<String, String> additionalParameters) {
		...
		params.set("grant_type", AzureGrantType.PASSWORD.asString());
	...
	private AzureADSecurityToken postForADToken(){
		MultiValueMap<String, String> params = new LinkedMultiValueMap<>();
		params.set("grant_type", AzureGrantType.CLIENT_CREDENTIALS.asString());
		params.set("client_id", clientId);
		params.set("client_secret", clientSecret);
		params.set("resource", uriProvider.getResourceUri());
		return getRestTemplate().postForObject(authorizeUrl+"?api-version=1.0", params, AzureADSecurityToken.class);
	}
	...
	protected AccessGrant createAccessGrant(String accessToken, String scope, String refreshToken, Long expiresIn, String idToken, Map<String, Object> response) {
		return new AzureAccessGrant(accessToken, scope, refreshToken, idToken, expiresIn);
	}
	...
	private AzureGrantType convertGrantType(GrantType grantType){
		return grantType.equals(GrantType.AUTHORIZATION_CODE) ? AzureGrantType.JWT_TOKEN : AzureGrantType.CLIENT_CREDENTIALS;
	}
}
